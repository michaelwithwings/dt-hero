...
export default function EditIconButton({ id, title, value, maxLength, colors, onCommit, style }: EditIconButtonProps) {
  ...
  return (
    <span style={{ position: "relative", display: "inline-flex", ...style }}>
      ...
      >
        <svg width="28" height="28" viewBox="0 0 18.643 22.771" fill="currentColor">
